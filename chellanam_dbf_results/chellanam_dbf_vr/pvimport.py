...
contcalc = paraview.simple.Calculator(Input=surface, ResultArrayName='h', Function='z - zb')
contoursh = paraview.simple.Contour(Input=contcalc, ContourBy='h', Isosurfaces=hcont)
